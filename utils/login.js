...
var login = function login(options) {
    ...
    var doLogin = () => getWxLoginResult(function (wxLoginError, wxLoginResult) {
        ...
        options.data = utils.extend({}, options.data, {'code':wxLoginResult.code});
        // 请求服务器登录地址，获得会话信息
        wx.request({
            ...
            success: function (result) {
                ...
                if (data && data.resultCode === 0) {
                    ...
                    var openId = data.resultEntity.openid;
                    var sessionKey = data.resultEntity.sessionkey;
                    if (sessionKey) {
    ...
    if (session) {
        wx.checkSession({
            success: function () {
                options.success(Session.getUserInfo());
            },
